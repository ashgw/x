...
<C>
  ...
  test your app logic, assuming you resisted your natural inclination to <L href="/mock-async-python">mock</L> these connections and call it a day, so how do you test them ? 
</C>
<H2>Solution</H2>
<C>
