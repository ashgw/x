...
isReleased: true
isSequel: false
lastModDate: 2024-05-17T09:15:00-0401
firstModDate: 2024-05-17T09:15:00-0401
minutesToRead: 2
tags:
  - "maintainability"
  - 'ci'
...
<C>If a workflow doesn’t fit the formula, or has too shenanigans, sure, name it however you want. Just keep everything that can be structured visibly clear with the formula. When you open the workflows folder, it should read like a timeline, not a guessing game.</C>
