...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[1.1rem] font-semibold select-none",
  {
    variants: {
      variant: {
        default:
        ...
        outlineUpdated: "text-success",
        outlineArchive: "text-muted-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
