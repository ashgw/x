...
export const blogs: Blog[] = [
  {
    ...
    mdxContentRaw: `
<C>
  Not all TypeScript code is created equal. Some of it’s fine, but for a lot of
  it, let’s just say “type safety” is more of a suggestion than a rule. If you
  want to actually write <b>safe</b>, <b>robust</b>, and <b>bug-resistant</b>
  TypeScript, you need to step it up. One way to do that is by using a pattern
  called <b>Branded Types</b> (also known as Nominal Types, Unique Types, or New
  Types). Different names, same goal: giving your types the specificity they
  deserve instead of leaving your code to guesswork.
</C>
...
<C>
  ...
  undetected. Multiply this by hundreds of lines in a real-world codebase, and
  you’ve got a disaster brewing. So, how do you fix this? Branded Types.
</C>
...
<C>
  By the way, the <code>ts-roids</code> library I created includes a{" "}
  <code>NewType</code> utility and more than 120+ type-safe utilities to
  bulletproof your TypeScript code. Check it out{" "}
